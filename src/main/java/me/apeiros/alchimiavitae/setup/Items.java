...
public class Items {
    ...
    public static final SlimefunItemStack CONDENSED_SOUL = new SlimefunItemStack("AV_CONDENSED_SOUL",
            Material.LIGHT_BLUE_DYE, Utils.legacySerialize("<gradient:#6baefa:#7145b0>凝魂</gradient>"),
            "&b一個靈魂, 凝聚成一顆球",
            "&9&o也許有方法",
            "&9&o可以操縱它的力量...");
    ...
    public static final SlimefunItemStack PLANT_INFUSION_CHAMBER = new SlimefunItemStack("AV_PLANT_INFUSION_CHAMBER",
            Material.LIME_STAINED_GLASS, Utils.legacySerialize("<gradient:#549c64:#1de078>植物浸液室</gradient>"),
            "&b可以為植物注入暗",
            "&b或光能量, 用於",
            "&b靈魂與魔法顆粒", "",
    ...
    public static final SlimefunItemStack GOOD_MAGIC_PLANT = new SlimefunItemStack("AV_GOOD_MAGIC_PLANT",
            Material.OAK_SAPLING, Utils.legacySerialize("<gradient:#2ddae0:#31f876>光魔法植物</gradient>"),
            "&7光魔法 I",
            "&a散發著至高無上的光芒",
            "&a發光的與眾不同...");
    ...
    public static final SlimefunItemStack EVIL_MAGIC_PLANT = new SlimefunItemStack("AV_EVIL_MAGIC_PLANT",
            Material.OAK_SAPLING, Utils.legacySerialize("<gradient:#ff5555:#ffa012>暗魔法植物</gradient>"),
            "&7暗魔法 I",
            "&c包含了無數的黑暗",
            "&c魔法被鎖在它的木質中...");
    ...
    public static final SlimefunItemStack GOOD_ESSENCE = new SlimefunItemStack("AV_GOOD_ESSENCE",
            Material.SUGAR, Utils.legacySerialize("<gradient:#2ddae0:#31f876>光之精華</gradient>"),
            "&7光魔法 II",
            "&a生命. 照亮身旁. ");

    public static final SlimefunItemStack EVIL_ESSENCE = new SlimefunItemStack("AV_EVIL_ESSENCE",
            Material.GUNPOWDER, Utils.legacySerialize("<gradient:#ff5555:#ffa012>暗之精華</gradient>"),
            "&7暗魔法 II",
            "&c死亡. 黑暗侵蝕.");

    public static final SlimefunItemStack EXP_CRYSTALLIZER = new SlimefunItemStack("AV_EXP_CRYSTALLIZER",
            Material.LIME_STAINED_GLASS, Utils.legacySerialize("<gradient:#50fa75:#3dd2ff>經驗結晶機</gradient>"),
            "&a將經驗球轉化成晶體狀,",
            "&a耐用並充滿活力的形式.",
            LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE),
            LoreBuilder.speed(1),
    ...
    public static final SlimefunItemStack EXP_CRYSTAL = new SlimefunItemStack("AV_EXP_CRYSTAL",
            Material.EMERALD, Utils.legacySerialize("<gradient:#50fa75:#3dd2ff>經驗結晶</gradient>"),
            "&a一大塊晶瑩剔透的經驗");
    ...
    public static final SlimefunItemStack ILLUMIUM = new SlimefunItemStack("AV_ILLUMIUM",
            Material.IRON_INGOT, Utils.legacySerialize("<gradient:#2ddae0:#31f876>光明錠</gradient>"),
            "&a它有力的在你手上散發出光芒");
    ...
    public static final SlimefunItemStack DARKSTEEL = new SlimefunItemStack("AV_DARKSTEEL",
            Material.NETHERITE_INGOT, Utils.legacySerialize("<gradient:#ff5555:#ffa012>暗鋼錠</gradient>"),
            "&c它散發著... 無盡的黑暗?");
    ...
    public static final SlimefunItemStack DIVINE_ALTAR = new SlimefunItemStack("AV_DIVINE_ALTAR",
            Material.ENCHANTING_TABLE, Utils.legacySerialize("<gradient:#ff5555:#ff6cfd>神聖祭壇</gradient>"),
            "&5用於進行古代儀式",
            "&5的神聖裝置");

    public static final SlimefunItemStack MOLTEN_MYSTERY_METAL = new SlimefunItemStack("AV_MOLTEN_MYSTERY_METAL",
            Material.LAVA_BUCKET, Utils.legacySerialize("<gradient:#ff6745:#ff5555>融化的神秘金屬</gradient>"),
            "&6不同於金屬的聚合體");

    public static final SlimefunItemStack MYSTERY_METAL = new SlimefunItemStack("AV_MYSTERY_METAL",
            Material.IRON_INGOT, Utils.legacySerialize("<gradient:#ff6745:#ff5555>神秘金屬錠</gradient>"),
            "&6含有多種金屬");

    public static final SlimefunItemStack ORNATE_CAULDRON = new SlimefunItemStack("AV_ORNATE_CAULDRON",
            Material.CAULDRON, Utils.legacySerialize("<gradient:#57ebbe:#f6fa2a>華麗鍋釜</gradient>"),
            "&2用於釀造藥水的高級鍋釜");

    public static final SlimefunItemStack POTION_OF_OSMOSIS = new SlimefunItemStack("AV_POTION_OF_OSMOSIS",
            Material.DRAGON_BREATH, Utils.legacySerialize("<gradient:#6274e7:#8752a3>滲透藥水</gradient>"),
            "&6吸收你的藥水效果",
            "&6並將它們儲存在瓶子中 &e右鍵點擊");
    ...
    public static final SlimefunItemStack ALTAR_OF_INFUSION = new SlimefunItemStack("AV_ALTAR_OF_INFUSION",
            Material.LODESTONE, Utils.legacySerialize("<gradient:#f78770:#ff607b>灌注祭壇</gradient>"),
            "&5結合科技的祭壇",
            "&5和巫術來注入物品",
            "&5具有強大的屬性",
            "&d只能注入 金, 鐵, 鑽石, 或獄髓,",
